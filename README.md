...
##### `event_history_cli`
Enable/Disable cli event history buffer. Valid values are 'true'(=>size_small), 'false', 'size_small', 'size_medium', 'size_large', 'size_disable' and 'default'.

##### `event_history_detail`
Enable/Disable detail event history buffer. Valid values are 'true'(=>size_disable), 'false', 'size_small', 'size_medium', 'size_large', 'size_disable' and 'default'.

##### `event_history_events`
Enable/Disable events history buffer. Valid values are 'true'(=>size_small), 'false', 'size_small', 'size_medium', 'size_large', 'size_disable' and 'default'.
