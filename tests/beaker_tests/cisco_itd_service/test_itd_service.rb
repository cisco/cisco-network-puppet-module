...
tests[:default_plat_2] = {
  desc:           '1.2 Defaults for platform specific part 2',
  platform: 'n9k',
  title_pattern:  'myService',
  preclean:       'cisco_itd_service',
  manifest_props: {
...
tests[:non_default_plat_2] = {
  desc:           '2.2 Non Defaults for platform specific part 2',
  platform: 'n9k',
  title_pattern:  'myService',
  preclean:       'cisco_itd_service',
  manifest_props: {
...
def test_harness_dependencies(_tests, _id)
  cmd = 'ip acess-list iap ; ip access-list eap ; interface ethernet 1/1 ; no switchport ; exit ; feature interface-vlan ; vlan 2; interface vlan 2; interface port-channel 100 ; feature itd ; itd device-group udpGroup ; node ip 2.2.2.2 ; exit ; node ip 3.3.3.3'
