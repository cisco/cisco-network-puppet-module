...
# TestCase Name:
# -------------
# ExtendedVlan-Provider-Defaults.rb
#
...
# TestCase:
# ---------
# This is a EXTVLAN resource test that tests for default values for
...
result = 'PASS'
testheader = 'EXTVLAN Resource :: All Attributes Defaults'

# @test_name [TestCase] Executes defaults testcase for EXTVLAN Resource.
