...
# TestCase Name:
# -------------
# OspfVrf-Provider-NonDefaults.rb
#
...
# TestCase:
# ---------
# This is a OSPFVRF resource test that tests for nondefault values for
...
result = 'PASS'
testheader = 'OSPFVRF Resource :: All Attributes NonDefaults'

# @test_name [TestCase] Executes nondefaults testcase for OSPFVRF Resource.
