...
# TestCase Name:
# -------------
# StandardVlan-Provider-Negatives.rb
#
...
# TestCase:
# ---------
# This is a STDVLAN resource test that tests for negative values for
...
result = 'PASS'
testheader = 'STDVLAN Resource :: All Attributes Negatives'

# @test_name [TestCase] Executes negatives testcase for STDVLAN Resource.
