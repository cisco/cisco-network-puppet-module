...
# TestCase Name: 
# -------------
# StandardVlan-Provider-NonDefaults.rb
#
...
# TestCase:
# ---------
# This is a STDVLAN resource test that tests for nondefault values for 
...
test_name "TestCase :: #{testheader}" do
  ...
  step "TestStep :: Check vlan instance presence on agent" do
    ...
    on(agent, cmd_str) do
      UtilityLib.search_pattern_in_output(stdout, [/vlan 128/,
        /name DESCR-VLAN0128/],
        false, self, logger)
    end
