...
# TestCase:
# ---------
# This is a SNMPCOMMUNITY resource test that tests for default values for
...
result = 'PASS'
testheader = 'SNMPCOMMUNITY Resource :: All Attributes Defaults'

# @test_name [TestCase] Executes defaults testcase for SNMPCOMM Resource.
