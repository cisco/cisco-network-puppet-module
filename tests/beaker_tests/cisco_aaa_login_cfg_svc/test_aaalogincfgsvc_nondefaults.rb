...
# TestCase Name:
# -------------
# AaaLoginCfgSvc-Provider-Nondefaults.rb
#
...
# TestCase:
# ---------
# This is a AaaLoginCfgSvc resource test that tests for non-default values of all
...
# Require UtilityLib.rb and AaaLoginCfgLib.rb paths.
...
test_name "TestCase :: #{testheader}" do
  ...
  %w(console default).each do |title|
    ...
    create_aaalogincfgsvc_manifest_full(tests, id)
