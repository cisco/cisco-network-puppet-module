...
# TestCase:
# ---------
# This is a TACACSSERVER resource test that tests for default values for
...
result = 'PASS'
testheader = 'TACACSSERVER Resource :: All Attributes Defaults'

# @test_name [TestCase] Executes defaults testcase for TACACSSERVER Resource.
