...
# TestCase Name: 
# -------------
# LoopbackIntf-Provider-Negatives.rb
#
...
# TestCase:
# ---------
# This is a LOOPBACKINTF resource test that tests for negative values for 
...
result = 'PASS'
testheader = "LOOPBACKINTF Resource :: All Attributes Negatives"

# @test_name [TestCase] Executes negatives testcase for LOOPBACKINTF Resource.
