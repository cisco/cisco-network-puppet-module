...
# TestCase Name:
# -------------
# test_encapsulation.rb
#
# TestCase Prerequisites:
# -----------------------
# This is a Puppet encapsulation resource testcase for Puppet Agent on
...
# TestCase:
# ---------
# This encapsulation resource test verifies all properties.
#
...
def puppet_resource_cmd
  cmd = PUPPET_BINPATH + 'resource cisco_encapsulation'
...
def build_manifest_encapsulation(tests, id)
  ...
  logger.debug("build_manifest_encapsulation :: title_pattern:\n" +
               tests[id][:title_pattern])
  tests[id][:manifest] = "cat <<EOF >#{PUPPETMASTER_MANIFESTPATH}
  node 'default' {
    cisco_encapsulation { '#{tests[id][:title_pattern]}':
      #{state}
      #{tests[id][:manifest_props]}
    }
  }
