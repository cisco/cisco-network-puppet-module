...
# TestCase Name:
# -------------
# LoopbackIntf-Provider-NonDefaults.rb
#
...
# TestCase:
# ---------
# This is a LOOPBACKINTF resource test that tests for nondefault values for
...
result = 'PASS'
testheader = 'LOOPBACKINTF Resource :: All Attributes NonDefaults'

# @test_name [TestCase] Executes nondefaults testcase for LOOPBACKINTF Resource.
