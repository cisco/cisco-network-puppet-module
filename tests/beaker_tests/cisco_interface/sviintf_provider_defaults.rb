...
# TestCase:
# ---------
# This is a SVIINTF resource test that tests for default values for
...
result = 'PASS'
testheader = 'SVIINTF Resource :: All Attributes Defaults'

# @test_name [TestCase] Executes defaults testcase for SVIINTF Resource.
test_name "TestCase :: #{testheader}" do
  ...
  step 'TestStep :: Get resource present manifest from master' do
    # Expected exit_code is 0 since this is a bash shell cmd.
    on(master, SviIntfLib.create_sviintf_manifest_present)
