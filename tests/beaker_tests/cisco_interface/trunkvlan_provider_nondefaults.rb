...
# TestCase Name:
# -------------
# TrunkVlan-Provider-NonDefaults.rb
#
...
# TestCase:
# ---------
# This is a TRUNKVLAN resource test that tests for nondefault values for
...
result = 'PASS'
testheader = 'TRUNKVLAN Resource :: All Attributes NonDefaults'

# @test_name [TestCase] Executes nondefaults testcase for TRUNKVLAN Resource.
test_name "TestCase :: #{testheader}" do
  ...
  step 'TestStep :: Get resource nondefaults manifest from master' do
    # Expected exit_code is 0 since this is a bash shell cmd.
    on(master, TrunkVlanLib.create_trunkvlan_manifest_nondefaults)
