...
# TestCase Name:
# -------------
# NtpConfig-Provider-Defaults.rb
#
# TestCase Prerequisites:
# -----------------------
# This is a ntp_config resource testcase for Puppet Agent on Nexus devices.
...
# TestCase:
# ---------
# This is a ntp_config resource test that tests for default value for
# 'ensure' attribute of a ntp_config resource.
#
...
require File.expand_path('../ntp_configlib.rb', __FILE__)
...
test_name "TestCase :: #{testheader}" do
  ...
  # @step [Step] Checks ntp_config resource on agent using resource cmd.
