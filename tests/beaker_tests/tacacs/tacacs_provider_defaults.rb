...
# TestCase Name:
# -------------
# Tacacs-Provider-Defaults.rb
#
# TestCase Prerequisites:
# -----------------------
# This is a tacacs resource testcase for Puppet Agent on Nexus devices.
...
# TestCase:
# ---------
# This is a tacacs resource test that tests for default value for
# 'ensure' attribute of a tacacs resource.
#
...
require File.expand_path('../tacacslib.rb', __FILE__)

result = 'PASS'
testheader = 'tacacs Resource :: All Attributes Defaults'
...
test_name "TestCase :: #{testheader}" do
  ...
  # @step [Step] Checks tacacs resource on agent using resource cmd.
  ...
  # @step [Step] Requests manifest from the master server to the agent.
  step 'TestStep :: Get resource present (disabled) manifest from master' do
    # Expected exit_code is 0 since this is a bash shell cmd.
    on(master, TacacsLib.create_tacacs_manifest_change_disabled)
